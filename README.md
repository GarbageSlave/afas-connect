...
From 'afas-connect/models' you can import some enums which make some options more verbose.
They are for convience, so you can still just use 1 instead of OperatorTypes.EqualTo if you want to.

```js
// All enums
import { OrderBy, OperatorTypes, Languages, EnvTypes, ImageSizes } from 'afas-connect/models'; 
```
