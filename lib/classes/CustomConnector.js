...
class CustomConnector extends Connector_1.default {
     ...
     *
     */
    image(format, imageId, inBinary = false) {
        return __awaiter(this, void 0, void 0, function* () {
            try {
                return yield this.http(this.afasUrl + 'imageconnector/' + imageId + '?format=' + format, 'GET', undefined, { headers: { SendFileAsBinary: inBinary ? "1" : "0" } });
            }
            catch (error) {
...
exports.default = CustomConnector;
