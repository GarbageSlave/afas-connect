...
class DataConnector extends Connector_1.default {
    ...
    file(fileId, fileName, binary = false) {
        return __awaiter(this, void 0, void 0, function* () {
            try {
                return yield this.http(this.afasUrl + 'fileconnector/' + encodeURIComponent(fileId) + '/' + encodeURIComponent(fileName), 'GET', undefined, { headers: { SendFileAsBinary: binary ? "1" : "0" } });
            }
            catch (error) {
    ...
    image(format, imageId, binary = false) {
        return __awaiter(this, void 0, void 0, function* () {
            try {
                return yield this.http(this.afasUrl + 'imageconnector/' + imageId + '?format=' + format, 'GET', undefined, { headers: { SendFileAsBinary: binary ? "1" : "0" } });
            }
            catch (error) {
    ...
    report(reportId, additionalFilter, binary = false) {
        return __awaiter(this, void 0, void 0, function* () {
            try {
                return yield this.http(this.afasUrl + 'reportconnector/' + encodeURIComponent(reportId) + additionalFilter, 'GET', undefined, { headers: { SendFileAsBinary: binary ? "1" : "0" } });
            }
            catch (error) {
